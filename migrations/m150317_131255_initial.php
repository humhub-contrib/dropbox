...
class m150317_131255_initial extends EDbMigration
{
	public function up()
	{ 
	    ...
	    $this->insert('setting', array('name' => 'warningOnPosting', 'value'=>'1', 'module_id' => 'dropbox','created_at' => new CDbExpression('NOW()'), 'updated_at' => new CDbExpression('NOW()')));
	}
